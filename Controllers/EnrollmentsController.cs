...
public class EnrollmentsController : Controller
{
	...
	public async Task<IActionResult> Create([Bind("Id,StudentId,ClassId,Time")] Enrollment enrollment)
	{
	...
	[HttpPost]
	[ValidateAntiForgeryToken]
	public async Task<IActionResult> Edit(int id, [Bind("Id,StudentId,ClassId,Time")] Enrollment enrollment)
	{
		if (id != enrollment.Id)
		{
			return NotFound();
